...
export const PATIENT_QUEUE = [
  ...
  },
  {
    ...
    age: 32,
    gender: "Female",
    complaint: "Recurring abdominal pain, mild nausea",
    time: "09:30",
    status: "in-progress",
    severity: "high",
    token: 13,
  },
  {
    ...
    age: 28,
    gender: "Male",
    complaint: "Persistent cough and cold, chest tightness",
    time: "09:45",
    status: "waiting",
    severity: "low",
    token: 14,
  },
  {
    ...
    age: 67,
    gender: "Female",
    complaint: "BP fluctuation, occasional dizziness",
    time: "10:00",
    status: "waiting",
    severity: "high",
    token: 15,
  ...
  },
  {
    ...
    age: 24,
    gender: "Female",
    complaint: "Skin rash on forearms, mild itching",
    time: "10:30",
    status: "waiting",
    severity: "low",
    token: 17,
...
export const PATIENT_APPOINTMENTS = [
  {
    ...
    report: {
      ...
      duration: "3 days",
      description:
        "High fever in evenings, recurring headache, severe body ache. Self-medication with paracetamol not helping much.",
  ...
  },
  {
    ...
    age: 24,
    gender: "Female",
    doctor: "Dr. Meera Subramanian",
    doctorId: "d-014",
    specialty: "Pediatrician",
    date: "Sat, 18 Jan",
    time: "2:30 PM",
    status: "upcoming",
    room: "OPD-C · 2nd floor",
    severity: "low",
    complaint: "Skin rash on forearms, mild itching",
    report: {
      ...
      duration: "5 days",
      description:
        "Small red rashes appeared on both forearms, itching is mild to moderate. Rash worsens in the evening. No fever or systemic symptoms.",
  ...
  },
  {
    ...
    report: {
      ...
      duration: "1 week",
      description:
        "Upper abdominal pain radiating to back, worse after meals. Associated with nausea and decreased appetite. No vomiting or diarrhea.",
      medicalHistory: ["GERD", "Anxiety disorder"],
      currentMedications: ["Omeprazole 20mg daily", "Sertraline 50mg daily"],
      allergies: "No known drug allergies",
    },
  },
];
...
export const ACTIVITY_LOGS = [
  {
    id: "1",
    timestamp: "10:45 AM",
    action: "Patient registered — Rajesh Kumar (OPD-0241)",
    user: "Reception · Anita",
    type: "register",
  },
  {
    id: "2",
    timestamp: "10:30 AM",
    action: "Consultation completed — Priya Sharma",
    user: "Dr. Mehta",
    type: "consult",
  },
  {
    id: "3",
    timestamp: "10:15 AM",
    action: "Voice complaint analyzed — confidence 92%",
    user: "AI Assistant",
    type: "ai",
  },
  {
  ...
  },
  {
    id: "5",
    timestamp: "09:55 AM",
    action: "Occupancy alert cleared — Cardiology",
    user: "System",
    type: "alert",
  },
  {
    id: "6",
    timestamp: "09:42 AM",
    action: "New appointment booked — Meera Subramanian",
    user: "Patient · Ananya",
    type: "book",
  },
  {
    id: "7",
    timestamp: "09:30 AM",
    action: "Admin exported daily OPD report (PDF)",
    user: "Admin · Rhea",
    type: "export",
  },
];
